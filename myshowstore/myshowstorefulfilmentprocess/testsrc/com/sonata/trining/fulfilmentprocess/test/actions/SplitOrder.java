 ...
 */
package com.sonata.trining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MyshowstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MyshowstoreFulfilmentProcessConstants.PARENT_PROCESS);
