 ...
 */
package com.sonata.trining.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, MyshowstoreFulfilmentProcessConstants.PARENT_PROCESS);
