...
/**
 * Global class for all MyshowstoreCore constants. You can add global constants for your extension into this class.
 */
public final class MyshowstoreCoreConstants extends GeneratedMyshowstoreCoreConstants
{
	public static final String EXTENSIONNAME = "myshowstorecore";


	private MyshowstoreCoreConstants()
	{
		//empty
	}
