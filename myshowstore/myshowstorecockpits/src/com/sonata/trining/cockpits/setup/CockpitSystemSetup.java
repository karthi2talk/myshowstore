 ...
 */
package com.sonata.trining.cockpits.setup;
...
import com.sonata.trining.cockpits.constants.MyshowstoreCockpitsConstants;
 ...
 */
@SystemSetup(extension = MyshowstoreCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MyshowstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MyshowstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MyshowstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/myshowstorecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
