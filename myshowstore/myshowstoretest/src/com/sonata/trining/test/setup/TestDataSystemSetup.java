 ...
 */
package com.sonata.trining.test.setup;
...
import com.sonata.trining.test.constants.MyshowstoreTestConstants;
import com.sonata.trining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MyshowstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/myshowstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/myshowstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/myshowstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/myshowstoretest/import/csquotes.impex");
		}
	}
}
