...
<html>
<head>
    <title>Welcome to personalizationtrail</title>
    <link rel="stylesheet" href="<c:url value="/static/personalizationtrail-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "personalizationtrail" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/personalizationtrail-items.xml</b> - here you can model your items</li>
            <li><b>resources/personalizationtrail-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/personalizationtrail-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/personalizationtrail-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/personalizationtrail-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
